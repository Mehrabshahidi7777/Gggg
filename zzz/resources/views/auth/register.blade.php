...
<div class="relative"><input id="register-password" name="password" type="password" class="w-full rounded-lg border pl-12" placeholder="رمز عبور"><button type="button" data-toggle-password="register-password" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">👁</button></div>
<div class="relative"><input id="register-password-confirmation" name="password_confirmation" type="password" class="w-full rounded-lg border pl-12" placeholder="تکرار رمز عبور"><button type="button" data-toggle-password="register-password-confirmation" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">👁</button></div>
