            ...
            <form method="POST" action="{{ route('mobile.attach.request') }}"
                ...
                <label class="block">
                    ...
                    <input name="mobile"
                           ...
                           {{--
                               ⚠️ نقطه، نه یک شماره‌ی نمونه.

                               «09121234567» شماره‌ی واقعیِ یک نفر است و
                               بعضی کاربرها فکر می‌کنند باید همان را وارد
                               کنند، یا لحظه‌ای مکث می‌کنند تا بفهمند
                               شماره‌ی خودشان آنجا نوشته شده یا نه.

                               چهار رقم پیشوند و هفت نقطه، جمعاً ۱۱ -
                               یعنی شکلِ لازم را هم نشان می‌دهد.
                           --}}
                           placeholder="0913•••••••">
                </label>
