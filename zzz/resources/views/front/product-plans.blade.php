...
<div class="max-w-6xl mx-auto px-4 py-12">
    ...
    <p class="text-gray-500 mt-2">
        برای ثبت آگهی محصول در سایت، یکی از پلن‌های زیر را انتخاب کنید.
    </p>
        ...
        @foreach($plans as $plan)
            ...
            <div class="card p-5 flex flex-col">
                ...
                <div class="text-sm text-gray-500 mt-2">
                    ثبت آگهی محصول نامحدود در مدت اشتراک
                </div>

                <form
                    method="POST"
                    action="{{ route('product.plans.pay', $plan) }}"
                    class="mt-auto pt-6"
                >
